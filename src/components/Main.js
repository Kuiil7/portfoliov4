...
<div className="has-text-centered  ">       
    ...
    <p  className="subtitle is-6 slide-text ml-2 mb-1 mt-3 has-text-centered has-text-white  " > It is time to get out of the dark and fill the gap </p>
    <p  className="subtitle is-6 slide-text2 ml-2 mb-1  has-text-centered has-text-white  " > within the disability space.</p>
