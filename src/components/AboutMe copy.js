  ...
  <div className="column is-4">
    <span>
        ...
        <p className="is-size-7">At the top of Mammoth mountain, Mammoth Lakes, CA.</p>
           ...
           <p className="has-text-justified">I have had the privilege of working for two Fortune 500 companies (MCI WorldCom and AT&T) and as an independent contractor and linguistics graduate student at Gallaudet University. During my time at Gallaudet as a student, I created, migrated, and designed eight different campus units's CMS sites, including five third-party ePublication newsletter editions that highlighted the need to use video given that ASL is a visual language that, unlike a written text, requires motion tokkkkkkkkk be transmitted. In both sectors, combining the utilization of restrictive content management systems with a red-flag atmosphere was a dead end for the innovation of a visual language.</p>
  </span>
  </div>
